       ...
       <div className={styles.wrapper}>
         ...
         <div className={styles.createPostContainer}>
          {/* <img src={`${BASE_URL}/${authState.user.userId.profilePicture}`} alt="" /> */} 
           ...
           <img className={styles.usersProfile}  src={ authState?.user?.userId?.profilePicture 
           ? `${BASE_URL}/${authState.user.userId.profilePicture}` : "/default-avatar.png" }
         alt="profile"  />


         <input  value={postContent}  onChange={(e)=>setPostContent(e.target.value)}  type="text" placeholder="what's your mind?"
        
          className={styles.textAreaOfContainer} />

          {/* <input type="" value={commentBody} onChange={(e)=>setCommentBody(e.target.value)}
...

                  {
                    ...
                    <div onClick={async ()=>{
                      ...
                      await dispatch(getAllPosts())
                       ...
                       <svg style={{height:"1.2em ",color:"red",fontWeight:"bold",cursor:"pointer"}} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" 
...
{/*  */}
            ...
            <div className={styles.postCommentContainer}>
                    <input type="text" value={commentBody} onChange={(e)=>setCommentBody(e.target.value)}
                     ...
                     placeholder='write comments' />
                    <div  onClick={async ()=>{
                      await dispatch(postComment({post_id:postState.postId,body:commentBody}))
